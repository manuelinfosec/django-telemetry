"""
Django settings for TelemetryApp project.
...
SECRET_KEY = "django-insecure--a5hmr4=ax2*ee#sc)o*woc*(#g76mg3db=5zg8989410xoj-0"
...
ROOT_URLCONF = "TelemetryApp.urls"
...
WSGI_APPLICATION = "TelemetryApp.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("DATABASE_NAME") or "django_telemetry",
